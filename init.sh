...
EOF
  ...
  apt install curl wget bash-completion git less screen nftables vnstat xz-utils net-tools dnsutils mtr unzip iperf3 jq nethogs iftop lsof sudo systemd-timesyncd certbot python3-certbot-nginx -y
