...
worsttrace_install() {
  wget -O /usr/local/bin/worsttrace "https://cdn.1717178.xyz/Tools/worsttrace" && chmod +x /usr/local/bin/worsttrace
  coloredEcho $GREEN " WorstTrace 安装完成"
}

besttrace_install() {
  wget -O /usr/local/bin/besttrace "https://cdn.1717178.xyz/Tools/besttrace" && chmod +x /usr/local/bin/besttrace
